...
export default function StatCard({ icon, label, value, color, delay }) {
  return (
    <div className="glass glass-interactive stat-card group animate-in" style={{ animationDelay: delay }}>
      ...
      <div className="text-4xl font-extrabold text-text-main tracking-tighter tabular-nums">{value}</div>
    </div>
  );
}
